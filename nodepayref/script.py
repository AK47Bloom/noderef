...
def main():
    ...
    np_tokens = []  # List untuk menyimpan np_token
        ...
        try:
            ...
            if response_data['msg'] == 'Success':
                ...
                if response_data['msg'] == 'Success':
                    ...
                    np_tokens.append(auth_token)  # Simpan np_token ke dalam list
                    ...
                    if response_data['msg'] == 'Success':
                        ...
                        success_count += 1
                        # Simpan email dan password ke dalam file
    ...
    # Setelah loop selesai, simpan semua np_token ke file
